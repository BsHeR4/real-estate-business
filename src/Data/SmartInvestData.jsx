const SmartInvestData = [
  ...
  {
    icon: <img src='assets/imgs/service-icon-6.svg' alt="ROI Assessment" />,
  ...
  {
    icon: <img src='assets/imgs/service-icon-7.svg' alt="Customized Strategies" />,
  ...
  {
    icon: <img src='assets/imgs/service-icon-4.svg' alt="Diversification Mastery" />,
