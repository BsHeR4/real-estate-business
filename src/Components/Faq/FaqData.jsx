const faqData = [
    ...
    },
    {
        ...
        answer: "Explore the step-by-step guide to purchasing a property, from making an offer to closing the deal.",
    },
    {
        question: "Do you offer property management services?",
        answer: "Yes, we provide comprehensive property management services for landlords. Contact us for more details.",
    },
];
